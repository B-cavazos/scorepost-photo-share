    ...
    return (
        <div className={`mt-4 ml-10 ${lexend.className}`}>
            <div className='flex justify-between text-sm mb-5'>
                <h3 className='text-sm font-bold text-sp-gray dark:text-sp-blue-light'>Suggestions for you</h3>
                ...
                suggestions.map(profile=>(
                    <div key={profile.userId} className='flex items-center justify-between mt-3'>
                        ...
                        <div className='flex-1 px-5'>
                            ...
                            <h3 className='text-xs text-gray-400 dark:text-sp-blue-light'>contact: {profile.email}</h3>
                        </div>
                        <button className='text-sp-blue text-sm font-bold dark:text-sp-blue-lightMode'>Follow</button>
                    </div>
                ))
            }
        </div>
